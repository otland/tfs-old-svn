	...
	#define ID_MENU_RELOAD_CREATUREEVENTS 215
	#define ID_MENU_RELOAD_COMMANDS 216
	#define ID_MENU_RELOAD_CONFIG 217
	#define ID_MENU_RELOAD_HIGHSCORES 218
	#define ID_MENU_RELOAD_MONSTERS 219
	#define ID_MENU_RELOAD_MOVEMENTS 220
	#define ID_MENU_RELOAD_NPCS 221
	#define ID_MENU_RELOAD_QUESTS 222
	#define ID_MENU_RELOAD_RAIDS 223
	#define ID_MENU_RELOAD_SPELLS 224
	#define ID_MENU_RELOAD_TALKACTIONS 225
	#define ID_MENU_RELOAD_HOUSEPRICES 226
	#define ID_MENU_RELOAD_ALL 227
#endif

...
enum SpeakClasses
{
	...
	SPEAK_UNKNOWN_1		= 0x0A, //CHANNEL_O? tutors have to speak somehow...
	SPEAK_UNKNOWN_2		= 0x0B, //CHANNEL_RN? or something like just _RED?
	SPEAK_UNKNOWN_3		= 0x0C, //CHANNEL_O? the same, can be one of those two
	...
	SPEAK_CHANNEL_RN	= 0xFF + 5,
	SPEAK_CHANNEL_RA	= 0xFF + 6,
	SPEAK_PRIVATE_RED	= 0xFF + 7
};

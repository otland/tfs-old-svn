...
enum MagicEffect_t
{
	NM_MAGIC_DRAW_BLOOD	= 0x00,
	NM_MAGIC_LOSE_ENERGY	= 0x01,
	NM_MAGIC_POFF		= 0x02,
	NM_MAGIC_BLOCKHIT		= 0x03,
	NM_MAGIC_EXPLOSION_AREA	= 0x04,
	NM_MAGIC_EXPLOSION_DAMAGE	= 0x05,
	NM_MAGIC_FIRE_AREA		= 0x06,
	NM_MAGIC_YELLOW_RINGS	= 0x07,
	NM_MAGIC_POISON_RINGS	= 0x08,
	NM_MAGIC_HIT_AREA		= 0x09,
	NM_MAGIC_TELEPORT		= 0x0A, //10
	NM_MAGIC_ENERGY_DAMAGE	= 0x0B, //11
	NM_MAGIC_MAGIC_ENERGY	= 0x0C, //12
	NM_MAGIC_MAGIC_BLOOD	= 0x0D, //13
	NM_MAGIC_MAGIC_POISON	= 0x0E, //14
	NM_MAGIC_HITBY_FIRE	= 0x0F, //15
	NM_MAGIC_POISON		= 0x10, //16
	NM_MAGIC_MORT_AREA		= 0x11, //17
	NM_MAGIC_SOUND_GREEN	= 0x12, //18
	NM_MAGIC_SOUND_RED		= 0x13, //19
	NM_MAGIC_POISON_AREA	= 0x14, //20
	NM_MAGIC_SOUND_YELLOW	= 0x15, //21
	NM_MAGIC_SOUND_PURPLE	= 0x16, //22
	NM_MAGIC_SOUND_BLUE	= 0x17, //23
	NM_MAGIC_SOUND_WHITE	= 0x18, //24
	NM_MAGIC_BUBBLES		= 0x19, //25
	NM_MAGIC_CRAPS		= 0x1A, //26
	NM_MAGIC_GIFT_WRAPS	= 0x1B, //27
	NM_MAGIC_FIREWORK_YELLOW	= 0x1C, //28
	NM_MAGIC_FIREWORK_RED	= 0x1D, //29
	NM_MAGIC_FIREWORK_BLUE	= 0x1E, //30
	NM_MAGIC_STUN		= 0x1F, //31
	NM_MAGIC_SLEEP		= 0x20, //32
	NM_MAGIC_WATERCREATURE	= 0x21, //33
	NM_MAGIC_GROUNDSHAKER	= 0x22, //34
	NM_MAGIC_HEARTS		= 0x23, //35
	NM_MAGIC_FIREATTACK	= 0x24, //36
	NM_MAGIC_ENERGY_AREA	= 0x25, //37
	NM_MAGIC_SMALLCLOUDS	= 0x26, //38
	NM_MAGIC_HOLYDAMAGE	= 0x27, //39
	NM_MAGIC_BIGCLOUDS		= 0x28, //40
	NM_MAGIC_ICEAREA		= 0x29, //41
	NM_MAGIC_ICETORNADO	= 0x2A, //42
	NM_MAGIC_ICEATTACK		= 0x2B, //43
	NM_MAGIC_STONES		= 0x2C, //44
	NM_MAGIC_SMALLPLANTS	= 0x2D, //45
	NM_MAGIC_CARNIPHILA	= 0x2E, //46
	NM_MAGIC_PURPLEENERGY	= 0x2F, //47
	NM_MAGIC_YELLOWENERGY	= 0x30, //48
	NM_MAGIC_HOLYAREA		= 0x31, //49
	NM_MAGIC_BIGPLANTS		= 0x32, //50
	NM_MAGIC_CAKE		= 0x33, //51
	NM_MAGIC_GIANTICE		= 0x34, //52
	NM_MAGIC_WATERSPLASH	= 0x35, //53
	NM_MAGIC_PLANTATTACK	= 0x36, //54
	NM_MAGIC_TUTORIALARROW	= 0x37, //55
	NM_MAGIC_TUTORIALSQUARE	= 0x38, //56
	NM_MAGIC_MIRRORHORIZONTAL	= 0x39, //57
	NM_MAGIC_MIRRORVERTICAL	= 0x3A, //58
	NM_MAGIC_SKULLHORIZONTAL	= 0x3B, //59
	NM_MAGIC_SKULLVERTICAL	= 0x3C, //60
	NM_MAGIC_ASSASSIN		= 0x3D, //61
	NM_MAGIC_STEPSHORIZONTAL	= 0x3E, //62
	NM_MAGIC_BLOODYSTEPS	= 0x3F, //63
	NM_MAGIC_STEPSVERTICAL	= 0x40, //64
	NM_MAGIC_YALAHARIGHOST	= 0x41, //65
	NM_MAGIC_BATS		= 0x42, //66
	NM_MAGIC_SMOKE		= 0x43, //67
	NM_MAGIC_LAST		= NM_MAGIC_SMOKE,

	//for internal use, dont send to client
	NM_MAGIC_NONE		= 0xFF,
	NM_MAGIC_UNKNOWN		= 0xFFFF
};

...
enum ShootType_t
{
	...
	NM_UNK3				= 0x2E, //46, DEBUG!
	NM_PRISMATICBOLT        = 0x2F, //47
	NM_CRYSTALLINEARROW    = 0x30, //48
	NM_DRILLBOLT            = 0x31, //49
	NM_ENVENOMEDARROW        = 0x32, //50
	NM_SHOOT_LAST		= NM_ENVENOMEDARROW,
...
#define CHANNEL_GAMEMASTER 0x04

...
shopModule:addBuyableItem({'small health'}, 8610, 20, 1, 'small health potion')
...
shopModule:addBuyableItem({'great spirit'}, 8376, 190, 1, 'great spirit potion')
shopModule:addBuyableItem({'ultimate health'}, 8377, 310, 1, 'ultimate health potion')
shopModule:addBuyableItem({'antidote potion'}, 8378, 50, 1, 'antidote potion')
...
shopModule:addBuyableItem({'wand of draconia', 'draconia'}, 8827, 7500, 'wand of draconia')
...
shopModule:addSellableItem({'wand of draconia', 'draconia'}, 8827, 3750, 'wand of draconia')
...
shopModule:addSellableItem({'wand of starstorm', 'starstorm'}, 8826, 9000, 'wand of starstorm')
shopModule:addSellableItem({'wand of voodoo', 'voodoo'}, 8828, 11000, 'wand of voodoo')
...
shopModule:addSellableItem({'northwind rod', 'northwind'}, 8817, 3750, 'northwind rod')
...
shopModule:addSellableItem({'springsprout rod', 'springsprout'}, 8818, 9000, 'springsprout rod')
shopModule:addSellableItem({'underworld rod', 'underworld'}, 8816, 11000, 'underworld rod')

...
class Game
{
	public:
		...
		bool playerViolationWindow(uint32_t playerId, const std::string& targetName, uint8_t reason,
			ViolationAction_t action, const std::string& comment, uint32_t statementId,
			uint16_t channelId, bool ipBanishment);

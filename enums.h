...
enum CombatType_t
{
	...
	COMBAT_PHYSICALDAMAGE	= 0x01,
	COMBAT_ENERGYDAMAGE		= 0x02,
	COMBAT_EARTHDAMAGE		= 0x03,
	COMBAT_FIREDAMAGE		= 0x04,
	COMBAT_UNDEFINEDDAMAGE	= 0x05,
	COMBAT_LIFEDRAIN		= 0x06,
	COMBAT_MANADRAIN		= 0x07,
	COMBAT_HEALING			= 0x08,
	COMBAT_DROWNDAMAGE		= 0x09,
	COMBAT_ICEDAMAGE		= 0x0A,
	COMBAT_HOLYDAMAGE		= 0x0B,
	COMBAT_DEATHDAMAGE		= 0x0C,

...
class CreatureEvent : public Event
{
	public:
		...
		uint32_t executeOnMailSend(Player* player, Player* receiver, Item* item, bool openDepot);
		uint32_t executeOnMailReceive(Player* player, Player* sender, Item* item, bool openDepot);

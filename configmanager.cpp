...
bool ConfigManager::load()
{
	...
	m_confDouble[RATE_EXPERIENCE] = getGlobalDouble(L, "rateExperience", (double)1.0f);
	m_confDouble[RATE_SKILL] = getGlobalDouble(L, "rateSkill", (double)1.0f);
	m_confDouble[RATE_MAGIC] = getGlobalDouble(L, "rateMagic", (double)1.0f);
	...
	m_confDouble[PARTY_DIFFERENCE] = getGlobalDouble(L, "experienceShareLevelDifference", (double)0.66666666666667f);
